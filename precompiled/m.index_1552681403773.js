...
picked:B})});t.addEventListener("click",z);f.addEventListener("click",function(){b.dispatchEvent({type:"hide",room:b})});h&&h.addEventListener("click",A);c.addEventListener("keypress",function(a){if("13"==a.keyCode)return v(),!1});(new Task(function(){b.dispatchEvent(b.g()?{type:"getpms",userToId:b.i().b()}:{type:"getmessages",roomId:u});b.dispatchEvent({type:"getuserids",roomId:u});b.g()&&(e.add(a.userTo),e.add(p()))})).j()}};var SeenNotificationsManager = new (function () {
