...
})(Window.prototype, HTMLDocument.prototype, Element.prototype, "addEventListener", "removeEventListener", "dispatchEvent", []);/*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js */
...
})( window );String.prototype.splice = function(idx, rem, str) {
...
})();window.Room=new function(){function G(a){function A(){console.log("Room.UI.resize");h&&h.resize()}function z(){l.A(!0);c.c(!0)}function v(){l.A(!1);c.c(!1)}function B(a){a=Message.error({message:a.message});C(a)}EventEnabledBuilder(this);var b=this,n=!1,p=a.buttonSend,r=a.buttonExit,D=a.buttonEmoticons,t=a.buttonClose,l=a.buttonVideoPmStart,C=a.addMessage,f=a.videoFeed,u=a.videoPmOfferRejected;a=a.spinner;var k=E.DIV();k.classList.add("room");var q=E.DIV();q.classList.add("top");var m=E.DIV();m.classList.add("bottom");
var g=E.DIV();g.classList.add("feed");var e=E.DIV();e.classList.add("menu");var d=E.TEXT();d.classList.add("text");if(f){f=new VideoFeedUI(f);var h=new SplitPane({nPanelsWidth:1,nPanelsHeight:2,rowProfiles:[{height:"200px"}]});var x=h.s(0,0).a();var c=h.I(0);x.classList.add("video-feed-panel");x.appendChild(f.a());q.appendChild(h.a());h.s(0,1).a().appendChild(g);v();(new Task(h.resize)).j();f.addEventListener("show",z);f.addEventListener("hide",v);f.addEventListener("showmessagetouser",B);f.addEventListener("offerrejected",
u)}else q.appendChild(g);k.appendChild(q);k.appendChild(m);k.appendChild(a.a());m.appendChild(d);m.appendChild(e);e.appendChild(D.a());e.appendChild(p.a());e.appendChild(r.a());e.appendChild(t.a());l&&e.appendChild(l.a());d.addEventListener("keypress",function(a){this.resize=A;a||(a=window.F);b.dispatchEvent({type:"keypress",keyCode:a.keyCode||a.which})});this.a=function(){return k};this.o=function(){return g};this.c=function(a){n=a;k.style.display=a?"block":"none"};this.f=function(){return n};this.u=
function(){return d.value};this.B=function(a){g.appendChild(a.a())};this.w=function(a){var y=d.selectionStart;if(a){if(void 0==y)d.value+=a;else{var c=y+a.length;d.value=d.value.splice(y,0,a);d.selectionStart=d.selectionEnd=c}d.focus()}};this.l=function(){d.value=""};this.h=function(){g.scrollTop=g.scrollHeight};this.m=function(){return g.scrollTop>=g.scrollHeight-g.offsetHeight-10}}return function(a){function A(){m.start()}function z(){w.D();b.dispatchEvent({type:"dispose",room:b})}function v(){var a=
c.u();if(""!=a){var d=p();a=Message.G({str:a,userId:d.b(),username:d.v(),M:w.L(),emoticonsParser:C,pending:!0,clickMenuUser:g,getUserMe:p,image:d.H()});console.log(a);b.dispatchEvent(b.g()?{type:"sendpm",userToId:b.i().b(),message:a}:{type:"sendmessage",message:a,roomId:u});w.C(a);c.l();c.h()}}function B(a){c.w(a.J())}console.log(a);EventEnabledBuilder(this);var b=this,n=a.send,p=a.getUserMe,r=a.getUserById,D=a.getNDevice,t=a.getSessionId,l=a.showUsersSearch,C=a.emoticonsParser,f=a.name,u=a.id,k=
a.isPm,q=a.userTo,m;k&&(m=new VideoFeedPm({userTo:q,getSessionId:t,send:n}));n=a.ignoreManager;var g=a.clickMenuUser,e=new Users({getUserById:r}),d=new UsersMenu({name:a.isPm?"PM with "+a.userTo.v():f+" Users",users:e,id:u,ignoreManager:n,clickMenu:g,getUserMe:p,showUsersSearch:l});r=new Button({className:"button-send",text:"Send"});l=new Button({className:"button-emoticons"});f=new Button({className:"button-exit"});t=new Button({className:"button-close"});var h=k?new VideoButton({className:"button-video-pm-start"}):
void 0,x=new Spinner({});x.show();var c=new G({buttonSend:r,buttonEmoticons:l,buttonExit:f,buttonClose:t,buttonVideoPmStart:h,spinner:x,videoFeed:m,addMessage:function(a){var y=c.m();w.add(a);y&&c.h()},videoPmOfferRejected:function(a){console.log(a);b.dispatchEvent({type:"videopmofferrejected",userToId:q.b(),reason:a.reason})}}),w=new Messages({getUserId:function(){var a=p();if(a)return a.b()},element:c.o(),maxNMessages:100,ignoreManager:n,getNDevice:D});e.addEventListener("missingusers",b.dispatchEvent);
this.b=function(){return a.id};this.getName=function(){return a.name};this.i=function(){return a.userTo};this.g=function(){return k};w.addEventListener("showpm",function(a){b.dispatchEvent(a)});this.join=function(a){e.contains(a)||e.add(a)};this.close=z;this.a=c.a;this.c=function(a){var b=c.f();!b&&a?d.show():b&&!a&&d.K();c.c(a);a&&(new Task(function(){c.resize();c.h()})).j()};this.f=c.f;this.resize=c.resize;r.addEventListener("click",v);l.addEventListener("click",function(){b.dispatchEvent({type:"showemoticons",
picked:B})});t.addEventListener("click",z);f.addEventListener("click",function(){b.dispatchEvent({type:"hide",room:b})});h&&h.addEventListener("click",A);c.addEventListener("keypress",function(a){if("13"==a.keyCode)return v(),!1});(new Task(function(){b.dispatchEvent(b.g()?{type:"getpms",userToId:b.i().b()}:{type:"getmessages",roomId:u});b.dispatchEvent({type:"getuserids",roomId:u});b.g()&&(e.add(a.userTo),e.add(p()))})).j()}};var MessageComponents = new (function(){
...
var UserImage = new(function(){
	...
	var _UsersMenues = function(){
		...
		var ui = new UI({popupElement:window.isMobile?popup.getElement():undefined, getTopEntry:getTopEntry});
