...
/*!50003 DROP PROCEDURE IF EXISTS `xchat_pm_messages_get` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `xchat_pm_messages_get`(
in userMeIdIn int,
in userToIdIn int,
in nMessages int)
BEGIN
...
select tblRoomMessages.id, tblRoomMessages.roomId, userId, content, username, serverAssignedNMessage from tblRoomMessages 
INNER JOIN tblUsers on tblRoomMessages.userId = tblUsers.id
inner join tblpmmap on tblRoomMessages.roomId = tblpmmap.roomId where (tblpmmap.userMeId = userMeIdIn and tblpmmap.userToId = userToIdIn) or (tblpmmap.userMeId = userToIdIn and tblpmmap.userToId = userMeIdIn)  order by tblroommessages.id desc limit nMessages;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `xchat_pm_message_add` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `xchat_pm_message_add`(
in userMeIdIn int,
in userToIdIn int,
in contentIn text,
in serverAssignedNMessageIn int)
BEGIN
declare _roomId int;
SET NAMES utf8mb4;
call xchat_pm_room_id_from_user_get( userMeIdIn , userToIdIn, _roomId);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `xchat_pm_room_id_from_user_get` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `xchat_pm_room_id_from_user_get`(
in userMeIdIn int,
in userToIdIn int,
out _roomId int)
BEGIN
SET NAMES utf8mb4;
set _roomId = (select tblpmmap.roomId from tblpmmap where (tblpmmap.userMeId=userMeIdIn and tblpmmap.userToId = userToIdIn) or (tblpmmap.userMeId = userToIdIn and tblpmmap.userToId = userMeIdIn));
if(_roomId is null)
then
	insert into tblRooms(`Name`, `isPm`)  value(Concat('pm_',CAST(userMeIdIn AS CHAR),'_',CAST(userToIdIn AS CHAR)), TRUE);
	set _roomId = LAST_INSERT_ID();
	insert into tblpmmap (`roomId`, `userMeId`, `userToId`) values(_roomId, userMeIdIn, userToIdIn);
end if;
select _roomId;
END ;;
DELIMITER ;
...
INNER JOIN tblUsers on tblRoomMessages.userId = tblUsers.id where roomId=`roomId` order by id desc limit nMessages
) a order by id asc;	
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
