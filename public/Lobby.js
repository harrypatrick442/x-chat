var Lobby = (function(){
	...
	var _Lobby = function(){
		...
		var imageUploader = new ImageUploader({aspectRatio:1, profiles:[{desiredWidth:IMAGE_WIDTH_SMALL, name:SMALL}, {desiredWidth:IMAGE_WIDTH_LARGE, name:LARGE}], url:IMAGE_UPLOADER_URL});
